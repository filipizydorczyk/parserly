      ...
      assert.deepEqual(response, [
        {
          content: [
            ...
            { type: "bold", content: "consectetur adipiscing elit" },
            {
              type: "normal",
              content:
            ...
            { type: "code", content: "sem dolor, semper" },
            {
              type: "normal",
              content:
                "vitae vehicula vestibulum, suscipit eget ex. Morbi interdum, massa ut cursus vestibulum, nisl justo varius massa, eget",
            },
            { title: "tincidunt", url: new URL("http://example.com/") },
            { type: "normal", content: "nisi leo a sapien. Suspe" },
            { type: "italic", content: "ndi" },
            { type: "normal", content: "sse pretium ipsum dolor, ac ullam" },
            { title: "corper", url: new URL("http://example.com/") },
            { type: "normal", content: "quam blandit" },
