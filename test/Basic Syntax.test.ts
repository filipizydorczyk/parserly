  ...
  it("should parse all headers", () => {
    withTestFile(__filename, (markdown) => {
      ...
      assert.deepEqual(response, [
        ...
        {
          alt: "",
          url: new URL("https://images.news18.com/ibnlive/uploads/2021/12/spiderman-meme-16401651614x3.png"),
        },
        {
          alt: "alt text",
          url: new URL("https://images.news18.com/ibnlive/uploads/2021/12/spiderman-meme-16401651614x3.png"),
        },
        { title: "", url: new URL("http://example.com/") },
        { title: "Example", url: new URL("http://example.com/") },
      ]);
    });
  });
});
